...
export const SpotlightPoster = forwardRef<HTMLDivElement, { data: EventPosterData }>(
  function SpotlightPoster({ data }, ref) {
    ...
    return (
      ...
      >
        {/* Photo / monogram hero */}
        <div style={{ position: "relative", height: photoH, flexShrink: 0, overflow: "hidden" }}>
          {data.speakerPhotoUrl ? (
            ...
            <div style={{ width: "100%", height: "100%", background: `linear-gradient(150deg, ${ac.accent}, ${ac.deep})`, display: "flex", alignItems: "center", justifyContent: "center" }}>
          ...
          <div style={{ position: "absolute", inset: 0, background: `linear-gradient(to bottom, transparent 55%, ${ac.deep} 100%)` }} />
          {/* type tag */}
