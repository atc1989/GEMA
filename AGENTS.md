...
5. After the task: re-read the board. Do not invent the next step. Do not skip Changes. Do not touch production Auth (~431 users) until Change 1 is proven on Staging.
