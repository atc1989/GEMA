...
--
-- ON A LIVE DATABASE, DO NOT RUN THIS FILE. Use the two-step split instead:
--
--   event_slot_scheduling_step1.sql  additive only, safe with guests booking
--   event_slot_scheduling_step2.sql  replaces register_prospect_for_event
--
-- This file is the two concatenated, kept for reference and for a database
-- nobody is using. Section 6 drops the 11-argument register_prospect_for_event
-- that the deployed app calls on every booking, so running it whole against
-- Production breaks registration until the new app is live.
--
-- Model:
